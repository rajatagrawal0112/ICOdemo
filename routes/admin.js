...
routes.get('/main-dashboard', middleware_check_login, async (req, res) => {
  ...
  const ARTW_bal = await bscHelper.coinBalanceBNB(admin_wallet) //artw balance
  console.log(`290-artw`, ARTW_bal)

  const artwSold = await adminServices.artwSold(ARTW_bal)
  console.log(`290-artwSold`, artwSold)
...
routes.get('/update-token_details', middleware_check_login, async (req, res) => {
  err_msg = req.flash('err_msg');
  success_msg = req.flash('success_msg');
...
routes.get('/key-features', middleware_check_login, (req, res) => {
  KeyFeaturesInfo.find({ deleted: '0' }).then((keyFeatures) => {
    res.render('admin/admin-dashboard/front-admin/key-features', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash(), keyFeatures })
  }, (err) => {
    res.send('Some thing went wrong try again.');
  }).catch((e) => {
    res.send('Some thing went wrong try again.');
...
routes.get('/add-key-features', middleware_check_login, (req, res) => {

  res.render('admin/admin-dashboard/front-admin/add-key-features', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash() })
})

routes.post('/add-key-features', middleware_check_login, (req, res) => {
...
routes.get('/edit-key-features', middleware_check_login, (req, res) => {
  ...
  KeyFeaturesInfo.findOne({ _id: feature_id, deleted: '0' }).then((featureDetail) => {
    ...
    res.render('admin/admin-dashboard/front-admin/edit-keyfeature.ejs', { Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash(), featureDetail });
...
routes.get('/problem', middleware_check_login, (req, res) => {
  problemInfo.find({ deleted: '0' }).then((problemDetails) => {
    ...
    res.render('admin/admin-dashboard/front-admin/problem', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash(), problemDetails })
  }, (err) => {
    res.send('Some thing went wrong try again.');
  }).catch((e) => {
    res.send('Some thing went wrong try again.');
...
routes.get('/add-new-problem', middleware_check_login, (req, res) => {
  ...
  res.render('admin/admin-dashboard/front-admin/add-new-problem', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash() })
})
...
routes.get('/edit-problem', middleware_check_login, (req, res) => {
  ...
  problemInfo.findOne({ _id: id, deleted: '0' }).then((problem) => {
    res.render('admin/admin-dashboard/front-admin/edit-problem', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash(), problem })
  }, (err) => {
    res.send('Some thing went wrong try again.');
  }).catch((e) => {
    res.send('Some thing went wrong try again.');
...
//////////*****************solutions********************////////
routes.get('/solutions', middleware_check_login, (req, res) => {

  solutionInfo.find({ deleted: '0' }).then((solutionsDetails) => {
    //console.log(solutionsDetails)
    res.render('admin/admin-dashboard/front-admin/solution', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash(), solutionsDetails })
  }, (err) => {
    res.send('Some thing went wrong try again.');
  }).catch((e) => {
    res.send('Some thing went wrong try again.');
...
routes.get('/add-new-solution', middleware_check_login, (req, res) => {
  ...
  res.render('admin/admin-dashboard/front-admin/add-new-solution', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash() })
})
...
routes.get('/edit-solution', middleware_check_login, (req, res) => {
  ...
  solutionInfo.findOne({ _id: id, deleted: '0' }).then((solution) => {
    res.render('admin/admin-dashboard/front-admin/edit-solution', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash(), solution })
  }, (err) => {
    res.send('Some thing went wrong try again.');
  }).catch((e) => {
    res.send('Some thing went wrong try again.');
...
routes.get('/token-allocation', middleware_check_login, (req, res) => {
  tokenAllocation.find({ deleted: '0' }).then((tokenAllocationDetails) => {
    //console.log(solutionsDetails)
    res.render('admin/admin-dashboard/front-admin/token-allocations', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash(), tokenAllocationDetails })
  }, (err) => {
    res.send('Some thing went wrong try again.');
  }).catch((e) => {
    res.send('Some thing went wrong try again.');
...
routes.get('/add-new-token-allocation', middleware_check_login, (req, res) => {
  ...
  res.render('admin/admin-dashboard/front-admin/add-new-token-allocation', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash() })
})
...
routes.get('/edit-token-allocation', middleware_check_login, (req, res) => {
  ...
  tokenAllocation.findOne({ _id: id, deleted: '0' }).then((tokenAllocation) => {
    res.render('admin/admin-dashboard/front-admin/edit-token-allocation', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash(), tokenAllocation })
  }, (err) => {
    res.send('Some thing went wrong try again.');
  }).catch((e) => {
    res.send('Some thing went wrong try again.');
...
routes.get('/delete-token-allocation', middleware_check_login, (req, res) => {
...
routes.get('/roadmap', middleware_check_login, (req, res) => {
  milestone.find({ deleted: '0' }).then((milestoneData) => {

    res.render('admin/admin-dashboard/front-admin/roadmap', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash(), milestoneData })
...
routes.get('/add-new-milestone', middleware_check_login, (req, res) => {
  err_msg = req.flash('err_msg');
  success_msg = req.flash('success_msg');

  res.render('admin/admin-dashboard/front-admin/add-new-milestone', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash() })
...
routes.get('/edit-milestone', middleware_check_login, (req, res) => {
  id = req.query.id
  milestone.findOne({ _id: id, deleted: '0' }).then((milestone) => {
    res.render('admin/admin-dashboard/front-admin/edit-milestone', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash(), milestone })
  }, (err) => {
    res.send('Some thing went wrong try again.');
  }).catch((e) => {
    res.send('Some thing went wrong try again.');
...
routes.get('/delete-milestone', middleware_check_login, (req, res) => {
...
routes.get('/whitepaper', middleware_check_login, (req, res) => {
  whitepaperInfo.find({ deleted: '0' }).then((whitePaperData) => {

    res.render('admin/admin-dashboard/front-admin/whitepaper', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash(), whitePaperData })
...
routes.get('/add-new-whitepaper', middleware_check_login, (req, res) => {
  ...
  res.render('admin/admin-dashboard/front-admin/add-new-whitepaper', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash() })
})
...
routes.get('/edit-whitepaper', middleware_check_login, (req, res) => {
  ...
  whitepaperInfo.findOne({ _id: id, deleted: '0' }).then((whitepaper) => {
    res.render('admin/admin-dashboard/front-admin/edit-whitepaper', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash(), whitepaper })
  }, (err) => {
    res.send('Some thing went wrong try again.');
  }).catch((e) => {
    res.send('Some thing went wrong try again.');
...
routes.get('/delete-whitepaper', middleware_check_login, (req, res) => {
...
///////////***************blogs ****************///////////////////
routes.get('/blog-list', middleware_check_login, async (req, res) => {

  let blogdetails = await blogInfo.find({ deleted: '0' })

  res.render('admin/admin-dashboard/front-admin/blog-list', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash(), blogdetails })
})

routes.get('/add-new-blog', middleware_check_login, (req, res) => {

  res.render('admin/admin-dashboard/front-admin/add-new-blog', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash() })
})
...
routes.get('/delete-blog', middleware_check_login, (req, res) => {
  console.log('In delete blog')
  id = req.query.id
...
routes.get('/edit-blog', middleware_check_login, (req, res) => {
  id = req.query.id
  console.log('In dit blog', id)
  blogInfo.findOne({ _id: id, deleted: '0' }).then((blog) => {
    res.render('admin/admin-dashboard/front-admin/edit-blog', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash(), blog })
  }, (err) => {
    res.send('Some thing went wrong try again.');
  }).catch((e) => {
    res.send('Some thing went wrong try again.');
...
/////////////************faq list       *************/////////////////
routes.get('/faq-list', middleware_check_login, (req, res) => {

  FAQ.find({ deleted: '0' }).then((questionDetails) => {

    res.render('admin/admin-dashboard/front-admin/faq-list', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash(), questionDetails })
...
routes.get('/add-new-question', middleware_check_login, (req, res) => {

  res.render('admin/admin-dashboard/front-admin/add-new-question', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash() })
})
...
routes.get('/edit-question', middleware_check_login, (req, res) => {
  ...
  FAQ.findOne({ _id: id, deleted: '0' }).then((question) => {
    ...
    res.render('admin/admin-dashboard/front-admin/edit-question.ejs', { Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash(), question });
...
/////////////************* terms-n-conditions ************//////////////
routes.get('/terms-n-conditions', middleware_check_login, (req, res) => {
  termsAndConditionInfo.find({ deleted: '0' }).then((termsAndConditionDetails) => {

    res.render('admin/admin-dashboard/front-admin/terms-n-conditions', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash(), termsAndConditionDetails })
...
routes.get('/add-terms-n-conditions', middleware_check_login, (req, res) => {

  res.render('admin/admin-dashboard/front-admin/add-terms-n-conditions', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash() })
})


routes.post('/add-terms-n-conditions', middleware_check_login, (req, res) => {
  const form = formidable({ multiples: true });
  form.parse(req, (err, fields, files) => {
    ...
    termsAndCondition.save().then(result => {
      ...
      res.redirect('/terms-n-conditions');
    })
      .catch(err => {
        console.log(err);
      })
...
routes.get('/edit-terms-n-conditions', middleware_check_login, (req, res) => {
  let id = req.query.id;
  termsAndConditionInfo.findOne({ _id: id, deleted: '0' }).then((termsAndCondition) => {
    res.render('admin/admin-dashboard/front-admin/edit-terms-n-conditions', { Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash(), termsAndCondition });
...
routes.post('/edit-terms-n-conditions', middleware_check_login, (req, res) => {
  ...
  form.parse(req, (err, fields, files) => {
    ...
    termsAndConditionInfo.updateOne({ _id: id }, {
      ...
      if (err) {
        ...
        req.flash('success_msg', 'terms-n-conditions updated successfully.');
        res.redirect('/terms-n-conditions');
      }
    })
  })
...
routes.get('/delete-terms-n-conditions', middleware_check_login, (req, res) => {
  console.log('In delete terms-n-conditions')
  id = req.query.id
...
////////////**************  Privacy-Policy ************///////////////
routes.get('/admin-privacy-policy', middleware_check_login, (req, res) => {
  privacyPolicyInfo.find({ deleted: '0' }).then((privacyPolicyDetais) => {
    res.render('admin/admin-dashboard/front-admin/privacy-policy', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash(), privacyPolicyDetais })
  }, (err) => {
...
routes.get('/add-admin-privacy-policy', middleware_check_login, (req, res) => {
  ...
  res.render('admin/admin-dashboard/front-admin/add-privacy-policy', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash() })
})
...
routes.get('/edit-admin-privacy-policy', middleware_check_login, (req, res) => {
  ...
  privacyPolicyInfo.findOne({ _id: id, deleted: '0' }).then((privacyPolicy) => {
    res.render('admin/admin-dashboard/front-admin/edit-privacy-policy', { Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash(), privacyPolicy });
...
routes.get('/admin-cookie-policy', middleware_check_login, (req, res) => {
  ...
  res.render('admin/admin-dashboard/front-admin/cookie-policy', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash() })
})

routes.get('/referral-policy', middleware_check_login, (req, res) => {

  res.render('admin/admin-dashboard/front-admin/referral-policy', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash() })
})

routes.get('/contact-list', middleware_check_login, (req, res) => {

  res.render('admin/admin-dashboard/front-admin/contact-list', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash() })
})

routes.get('/basic-details', middleware_check_login, (req, res) => {

  res.render('admin/admin-dashboard/front-admin/basic-details', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash() })
})


routes.get('/feedback-list', middleware_check_login, (req, res) => {

  res.render('admin/admin-dashboard/front-admin/feedback-list', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash() })
})
...
//     //console.log(problemDetails)
//     res.render('admin/admin-dashboard/front-admin/order-history', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash(), orderDetails })
//   }, (err) => {
//     res.send('Some thing went wrong try again.');
//   }).catch((e) => {
//     res.send('Some thing went wrong try again.');
...
routes.get('/admin-referral-table', middleware_check_login, (req, res) => {
  ...
  res.render('admin/admin-dashboard/front-admin/referral-table', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash() })
})

routes.get('/summary', middleware_check_login, (req, res) => {

  res.render('admin/admin-dashboard/front-admin/summary', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash() })
})

routes.get('/bonus-persent', middleware_check_login, (req, res) => {

  res.render('admin/admin-dashboard/front-admin/bonus-persent', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash() })
})


routes.get('/transaction-table', middleware_check_login, (req, res) => {
  res.render('admin/admin-dashboard/front-admin/transaction-table', { err_msg, success_msg, Name: req.session.user_name, profile_image: req.session.profile_image, session: req.session, expressFlash: req.flash() })
})
